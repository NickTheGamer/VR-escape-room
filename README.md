...
```
cd existing_repo
git remote add origin https://eng-git.canterbury.ac.nz/nco63/escape-room.git
git branch -M main
...
- [ ] [Set up project integrations](https://eng-git.canterbury.ac.nz/nco63/escape-room/-/settings/integrations)
